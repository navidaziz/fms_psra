        ...
        <div class="page-header">
            ...
            <ul class="breadcrumb">
                <li>
                    ...
                    <a href="<?php echo site_url(ADMIN_DIR . "fine_management"); ?>">Fine Dashboard</a>
                </li>
                <li>
                    <i class="fa fa-list"></i>
                    <a href="<?php echo site_url(ADMIN_DIR . "fine_management"); ?>">Fined List</a>
                </li>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="clearfix">
                        <h4><?php echo $fine_summary->school_name; ?></h4>

                        <h5>
                            <?php if ($fine_summary->school_id) { ?>
                                School ID: <?php echo $fine_summary->school_id; ?>
                                <span style="margin-left: 10px;">
                                    REG: <?php echo $fine_summary->school_registration_no; ?>
                                </span>
                            <?php } else { ?>
                                Un Registered School
                            <?php } ?>
                            <span style="margin-left: 10px;">
                                (<?php echo $fine_summary->levelofInstituteTitle; ?>)
                            </span>
                        </h5>

                    </div>
                    <div class="description">District: <?php echo $fine_summary->district_name; ?> /
                        Tehsil: <?php echo $fine_summary->tehsil_name; ?> /
                        Address: <?php echo $fine_summary->address; ?> /
                        Contact: <?php echo $fine_summary->contact_number; ?>
                    </div>
                </div>
...
<div class="row">
    ...
    <div class="col-md-12" id="add_new_fine_form" style="display: no ne;">
        <form class="for m-inline" action="<?php echo site_url(ADMIN_DIR . "fine_management/add_fine"); ?>" id="add_fine" method="post" enctype="multipart/form-data">
            <input type="hidden" name="fined_school_id" value="<?php echo $fined_school_id ?>" />
...
<script>
    ...
    function delete_waived_off(fine_id, fine_waived_off_id) {
        ...
        if (confirm("Are you sure you want to delete ?")) {
            $.ajax({
                    method: "POST",
                    url: "<?php echo site_url(ADMIN_DIR . 'fine_management/delete_waived_off'); ?>",
                    data: {
                        fine_id: fine_id,
