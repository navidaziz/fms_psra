	...
	<div class="box border blue" id="messenger">
        ...
        <div class="box-body">
            ...
            <?php
                ...
                echo form_open_multipart(ADMIN_DIR."promo_codes/save_data", $add_form_attr);
            ?>
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "id"            =>  "min_basket_cost",
                        "class"         =>  "form-control",
						"title"         =>  $this->lang->line('min_basket_cost'),
                        "value"         =>  set_value("min_basket_cost"),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "id"            =>  "num_vouchers",
                        "class"         =>  "form-control",
						"title"         =>  $this->lang->line('num_vouchers'),
                        "value"         =>  set_value("num_vouchers"),
