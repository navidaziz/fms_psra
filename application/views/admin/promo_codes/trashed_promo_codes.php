...
<th><?php echo $this->lang->line('expiry'); ?></th>
            ...
            <td>
                <?php echo $promo_code->expiry; ?>
                            ...
                            <td>
                                <a class="llink llink-view" href="<?php echo site_url(ADMIN_DIR."promo_codes/view_promo_code/".$promo_code->promo_code_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-eye"></i> </a>
                                <a class="llink llink-restore" href="<?php echo site_url(ADMIN_DIR."promo_codes/restore/".$promo_code->promo_code_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-undo"></i></a>
                                <a class="llink llink-delete" href="<?php echo site_url(ADMIN_DIR."promo_codes/delete/".$promo_code->promo_code_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-times"></i></a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
