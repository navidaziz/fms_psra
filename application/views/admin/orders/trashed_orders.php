...
<th><?php echo $this->lang->line('customer_name'); ?></th>
            ...
            <td>
                <?php echo $order->order_picking_address; ?>
            </td>
            <td>
                <?php echo $order->order_drop_address; ?>
            </td>
            <td>
                <?php echo $order->delivery_charges; ?>
            </td>
            <td>
            ...
            <td>
                <?php echo $order->customer_name; ?>
                            ...
                            <td>
                                <a class="llink llink-view" href="<?php echo site_url(ADMIN_DIR."orders/view_order/".$order->order_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-eye"></i> </a>
                                <a class="llink llink-restore" href="<?php echo site_url(ADMIN_DIR."orders/restore/".$order->order_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-undo"></i></a>
                                <a class="llink llink-delete" href="<?php echo site_url(ADMIN_DIR."orders/delete/".$order->order_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-times"></i></a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
