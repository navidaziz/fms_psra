	...
	<div class="box border blue" id="messenger">
        ...
        <div class="box-body">
            ...
            <?php
                ...
                echo form_open_multipart(ADMIN_DIR."restaurant_food_menus/save_data", $add_form_attr);
            ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <?php
                    echo form_dropdown("restaurant_food_category_id", $restaurant_food_categories, "", "class=\"form-control\" required style=\"\"");
                    ?>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <?php
                    echo form_dropdown("restaurant_id", $restaurants, "", "class=\"form-control\" required style=\"\"");
                    ?>
                </div>
