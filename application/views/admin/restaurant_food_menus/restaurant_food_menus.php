...
<th><?php echo $this->lang->line('restaurant_name'); ?></th><th><?php echo $this->lang->line('Status'); ?></th><th><?php echo $this->lang->line('Action'); ?></th>
                        </tr>
						</thead>
						<tbody>
            ...
            <td>
                <?php echo $restaurant_food_menu->restaurant_name; ?>
                                ...
                                <td>
                                    <?php echo status($restaurant_food_menu->status,  $this->lang); ?>
                                    <?php
                                ...
                                <td>
                                <a class="llink llink-view" href="<?php echo site_url(ADMIN_DIR."restaurant_food_menus/view_restaurant_food_menu/".$restaurant_food_menu->restaurant_food_menu_id."/".$this->uri->segment(4)); ?>"><i class="fa fa-eye"></i> </a>
                                <a class="llink llink-edit" href="<?php echo site_url(ADMIN_DIR."restaurant_food_menus/edit/".$restaurant_food_menu->restaurant_food_menu_id."/".$this->uri->segment(4)); ?>"><i class="fa fa-pencil-square-o"></i></a>
                                <a class="llink llink-trash" href="<?php echo site_url(ADMIN_DIR."restaurant_food_menus/trash/".$restaurant_food_menu->restaurant_food_menu_id."/".$this->uri->segment(4)); ?>"><i class="fa fa-trash-o"></i></a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
