<div class="box-body">
                ...
                echo form_open_multipart(ADMIN_DIR."restaurants/add_food_menu/", $add_form_attr);
            ?>
                <input type="hidden" name="restaurant_food_category_id" value="<?php echo $restaurant_food_category_id; ?>" value="" />
