	...
	<div class="box border blue" id="messenger">
        ...
        <div class="box-body">
            ...
            <?php
                ...
                echo form_open_multipart(ADMIN_DIR."restaurant_food_categories/update_data/$restaurant_food_category->restaurant_food_category_id", $edit_form_attr);
            ?>
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $file = array(
                        ...
                        "class"         =>  "form-control",
                        "style"         =>  "","required"	  => "required","title"         =>  $this->lang->line('restaurant_food_category_image'),
