 		...
 		<div class="row fullscreen d-flex align-items-center justify-content-center">
 			...
 			<div class="banner-content col-lg-8 col-md-12">
 				...
 				<div class="input-wrap">
 					...
 					<h1 class="wow fadeIn" data-wow-duration="4s" style="color:#000 !important"> 032444424414</h1>
 				...
 				<h4 class="text-white" style="color:#F00 !important">Download <a href="">Android App</a> </h4>
 	...
 	<div class="container">
 		<div class="row align-items-center">
 			...
 			<div class="col-lg-12">
 				...
 				<p><em>Order from your favorite restaurant. </em></p>
